...
public abstract class ApiExceptionsHandlerHelper {
    ...
    protected static final String UNAUTHORIZED_ERROR_MESSAGE = "Unauthorized, you don't have enough permission!";
    ...
    protected static final HttpStatus UNAUTHORIZED_STATUS = HttpStatus.UNAUTHORIZED;
