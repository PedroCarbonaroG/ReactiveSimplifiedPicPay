...
public abstract class ApiExceptionsHandlerHelper /*extends ResponseEntityExceptionHandler*/ {
    ...
    protected static final String NO_CONTENT_WARNING_MESSAGE = "No content, the search was done with success but non record was found!";
    protected static final String UNAUTHORIZED_ERROR_MESSAGE = "Unauthorized, you are not allowed to access this resource";
    protected static final String INTERNAL_SERVER_ERROR_MESSAGE = "Internal Server Error, contact the administration to solve the problem!";
