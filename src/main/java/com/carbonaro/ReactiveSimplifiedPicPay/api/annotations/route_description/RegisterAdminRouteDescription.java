...
@Operation(
        summary = "Responsible route to create a new ADMIN user",
        description = "If everything went right, returns the user details",
        responses = {
                @ApiResponse(
                        responseCode = "200",
                        description = "If everything went right, returns the user admin details",
...
public @interface RegisterAdminRouteDescription {
}
