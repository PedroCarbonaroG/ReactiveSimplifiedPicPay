...
@Operation(
        summary = "Responsible route to extract naturals by filter",
        description = "If everything went right, returns the naturals extraction",
        responses = {
                @ApiResponse(
                        responseCode = "200",
                        description = "If everything went right, returns the naturals extraction",
...
public @interface NaturalsToExtractionRouteDescription {
}
