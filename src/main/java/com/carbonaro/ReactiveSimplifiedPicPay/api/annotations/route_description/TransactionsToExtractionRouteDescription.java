...
@Operation(
        summary = "Responsible route to extract transactions by filter",
        description = "If everything went right, returns the transactions extraction",
        responses = {
                @ApiResponse(
                        responseCode = "200",
                        description = "If everything went right, returns the transactions extraction",
...
public @interface TransactionsToExtractionRouteDescription {
}
