...
@Operation(
        summary = "Responsible route to delete an company.",
        description = "If everything went right, deletes a company by it's CNPJ",
        responses = {
                @ApiResponse(
                        responseCode = "200",
...
public @interface DeleteLegalPersonRouteDescription {
}
